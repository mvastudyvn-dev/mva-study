  ...
  async getSystemSettings(): Promise<any> {
    try {
      ...
      return {
        ...
        aiAnalysisEnabled: String(data.ai_analysis_enabled) === 'true' || localSettings.aiAnalysisEnabled === true,
        popupEnabled: String(data.popup_enabled) === 'true' || localSettings.popupEnabled === true,
        popupTitle: data.popup_title ?? localSettings.popupTitle ?? '',
        popupContent: data.popup_content ?? localSettings.popupContent ?? '',
        countdownEnabled: String(data.countdown_enabled) === 'true' || localSettings.countdownEnabled === true,
